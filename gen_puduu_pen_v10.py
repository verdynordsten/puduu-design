"""Puduu .pen generator v10 — "Fresh Start" (DocSpot-class).
...
tiles, status chips. Source of truth: mockups/v10-fresh.html (8.7/10).
...
def IC(icon, tile, name):
    ...
    return R(36, 36, tile, 12, f"{name}Tile", "vertical",
             [IMG(f"{A}/v10-{icon}.png", 19, 19, 5, f"{name}Ic")],
...
def HELLO(hello, sub, name, bell=False):
    ...
    if bell:
        kids.insert(1, R(38, 38, "card", 19, f"{name}Bell",
                         "vertical",
                         [IMG(f"{A}/v10-bell-soft.png", 19, 19, 5,
                              f"{name}BellIc")],
                         align="center", justify="center",
                         stroke="line", sw=1))
...
def SEARCH(hint, name):
    return R(350, 48, "card", 16, name, "horizontal",
             [IMG(f"{A}/v10-search-mute.png", 18, 18, 4,
                  f"{name}Ic"),
             ...
             [T(tag, 10.5, "mint", "700", "left", 318, DISP,
              ...
              R(318, None, "dark", 0, f"{name}Btns", "horizontal",
                [R(152, 48, "teal", 14, f"{name}Go", "horizontal",
                   [IMG(f"{A}/v10-play-white.png", 17, 17, 4,
                        f"{name}GoIc"),
...
def TABBAR(active):
    tabs = [("Today", "calendar-days"), ("Focus", "timer"),
            ("Reset", "sparkles"), ("Progress", "bar-chart-3"),
            ("Yours", "settings")]
    kids = []
    for lb, ic in tabs:
        on = lb == active
        ...
        cell = R(64, 52, "white" if on else "dark", 18, f"Tb{lb}",
                   "vertical",
                   [IMG(f"{A}/v10-{ic}-{'ink' if on else 'white'}.png",
                        22, 22, 5, f"Tb{lb}Ic"),
...
def main():
    s1 = SCREEN("01 Today", 0, [
        ...
        R(350, None, "bg", 0, "CatGrid", "horizontal", [
            R(80, 76, "card", 14, "C1", "vertical",
              [R(34, 34, "tealWash", 12, "C1T", "vertical",
                 [IMG(f"{A}/v10-timer-ink.png", 18, 18, 5, "C1I")],
                 align="center", justify="center"),
            ...
            R(80, 76, "card", 14, "C2", "vertical",
              [R(34, 34, "amberWash", 12, "C2T", "vertical",
                 [IMG(f"{A}/v10-zap-amber.png", 18, 18, 5, "C2I")],
                 align="center", justify="center"),
            ...
            R(80, 76, "card", 14, "C3", "vertical",
              [R(34, 34, "mossWash", 12, "C3T", "vertical",
                 [IMG(f"{A}/v10-check-moss.png", 18, 18, 5, "C3I")],
                 align="center", justify="center"),
            ...
            R(80, 76, "card", 14, "C4", "vertical",
              [R(34, 34, "chipGray", 12, "C4T", "vertical",
                 [IMG(f"{A}/v10-list-checks-soft.png", 18, 18, 5,
                      "C4I")],
                 align="center", justify="center"),
        ...
        CARD("timer-ink", "tealWash", "Deep work: portfolio",
             "09:00 · Hero section, phone away", "Begin", False,
             "T1"),
        CARD("check-moss", "mossWash", "Walk outside",
    ...
    s2 = SCREEN("02 Focus", 470, [
        ...
        R(350, None, "dark", 20, "TimerHero", "vertical", [
            ...
            R(318, None, "dark", 0, "FocusBtns", "horizontal", [
                R(152, 50, "teal", 14, "PauseBtn", "horizontal",
                  [IMG(f"{A}/v10-pause-white.png", 17, 17, 4,
                       "PauseIc"),
        ...
        CARD("check-moss", "mossWash", "Open the file",
             "Done · 2 min", "Done", True, "F1"),
        CARD("timer-ink", "tealWash", "Sketch hero section",
             "Now · 25 min", "25 min", False, "F2"),
        CARD("list-checks-soft", "chipGray", "Review + save",
    ...
    s3 = SCREEN("03 Reset", 940, [
        ...
        CARD("droplet-tealbright", "tealWash",
             "Drink a glass of water",
             "Stand up, sip slowly, look far away.", "2 min",
             False, "R1"),
        CARD("zap-amber", "amberWash", "Clear one surface",
             "Just the desk corner. Nothing more.", "2 min",
             False, "R2"),
        CARD("mail-open-soft", "mossWash",
             "Open the difficult email",
             "Read it only. Reply comes later.", "2 min",
             False, "R3"),
        CARD("list-checks-soft", "chipGray", "Sort the inbox",
    ...
    s4 = SCREEN("04 Progress", 1410, [
        ...
        CARD("bar-chart-3-ink", "tealWash", "Weekly shelf",
             "Early starter ×3 · Reset ×5 · Focus 25m ×8.",
             "W39", False, "G1"),
        CARD("trending-up-tealbright", "amberWash",
             "Focus trend",
             "Up 20% vs last week. Mornings win", "+20%",
             False, "G2"),
        CARD("heart-moss", "mossWash", "Resets that worked",
    ...
    s5 = SCREEN("05 Yours", 1880, [
        ...
        SEC("Settings", "", "S6"),
        CARD("bell-soft", "amberWash", "Gentle nudges",
             "Max 6 per day · quiet 22:00–07:00.", "On",
             False, "Y2"),
        CARD("volume-2-soft", "tealWash",
             "Sounds and haptics",
             "Calm chime · soft vibration.", "On", False,
             "Y3"),
        CARD("shield-check-soft", "chipGray",
             "Backup and export",
